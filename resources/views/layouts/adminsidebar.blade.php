...
<!-- whole sidebar -->
<div
    class="fixed dark:bg-black bg-white inset-y-0 left-0 w-[20%] h-full pr-2 flex-col gap-2 hidden sm:block transform transition-transform duration-300 ease-in-out z-10 pl-7 border-r-4 border-gray-500">
        ...
        <div class="overflow-auto">
            ...
            <div class="pt-4 flex items-center justify-between">
                <a href="{{ route('logout') }}" class="flex items-center gap-3">
                    <div class="w-[30px] h-[30px] rounded-full overflow-hidden">
                        <img class="rounded-full w-[30px] h-auto object-scale-down"
                            src="https://images.unsplash.com/photo-1756838197413-07f174def66c?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="profile">
                    </div>
