...
<!-- whole sidebar -->
<div class="fixed bg-black inset-y-0 left-0 w-[20%] h-full pr-2 flex-col gap-2 text-white sm:hidden md:hidden lg:flex transform transition-transform duration-300 ease-in-out z-20 pl-7 border-r-4 border-gray-500">
